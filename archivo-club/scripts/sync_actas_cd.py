#!/usr/bin/env python3
"""
Sync Actas CD from ferrocarriloeste.org.ar into archivo-club/actas-cd/.
...
DEFAULT_OUTDIR = REPO_ROOT / "actas-cd"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Directory that will receive the files and generated index. Relative paths are resolved under archivo-club/.",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
